...
class QLoRAEncoderModel(nn.Module):
    TRANSFORMER_CLS = AutoModel
    ...
    def build(
        ...
        print("***************Using 4bit Quantization Model & QLoRA***************")
        ...
        base_model = cls.TRANSFORMER_CLS.from_pretrained(model_args.model_name_or_path, quantization_config=config, **hf_kwargs)
    ...
    def load(cls,
        ...
        base_model = cls.TRANSFORMER_CLS.from_pretrained(model_name_or_path, quantization_config=config, **hf_kwargs)
